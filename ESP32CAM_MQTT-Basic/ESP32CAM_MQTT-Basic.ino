 ...
 * Actualizado por: José Ernesto Calvillo
...
const char* mqtt_server = "192.168.1.86"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
IPAddress server(192,168,1,86);
